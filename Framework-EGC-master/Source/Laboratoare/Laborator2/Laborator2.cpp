...
void Laborator2::Init()
{
	...
	// Create a mesh box using custom data
	{
		vector<VertexFormat> vertices
		{
			...
			VertexFormat(glm::vec3(0, 0, 3), glm::vec3(0, 1, 0)),
			...
			VertexFormat(glm::vec3(3, 0, 0), glm::vec3(0, 0, 1)),
		...
		vector<unsigned short> indices =
		{
			...
			6, 5, 7,	// indices for second triangle
			10, 11, 8,
			12,15,13 // TODO: Complete indices data
		};
	...
	// Create a mesh box using custom data
	{
		...
		// Create a new mesh from buffer data
		Mesh *patrat = CreateMesh("patrat1", vertices, indices);
	}
}
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["patrat1"], shaders["VertexColor"], glm::vec3(-1.0f, 1.0f, 0), glm::vec3(0.25f));
